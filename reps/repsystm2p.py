...
PARAM = ["data/chib2s_min2p.db", "data/chib2s_max2p.db"]
...
# Main
# ============================================================================
print renderer.render_name("systm2p-head", {})
# ============================================================================
...
for binning in BINNINGS:
    ...
    for i in range(2):
        ...
        rows.append("%.3f \\gevcc ($%s\\left[m(\chiboneTwoP)\\right]$)" %
                   (db_m[binning[0]]["mean_b1_2p"], prefix, ))
    ...
    print renderer.render_name("systm2p", context)
    print("}" if len(BINNINGS) > 1 else "")

print renderer.render_name("systm2p-foot", context)
